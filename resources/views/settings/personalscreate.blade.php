@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="row">
                <div class="col-md-10 ">
                    <h1 class="title">Add Employee Information</h1>
                </div>
                ...
                <div class="col-md-8 col-md-offset-2 ">
                    ...
                    <form action="{{route('personals.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="employee_info"   name="employee_info">
                        </div>
                        <div class="form-group">
                            <label for="employee_fb_link"> Facebook Link</label>
                            <input type="text" class="form-control" id="employee_fb_link"   name="employee_fb_link">
                        </div>
                        <div class="form-group">
                            <label for="employee_twitter_link"> Twitter Link</label>
                            <input type="text" class="form-control" id="employee_twitter_link"   name="employee_twitter_link">
                        </div>
                        <div class="form-group">
                            <label for="employee_instagram_link"> Instragam Link</label>
                            <input type="text" class="form-control" id="employee_instagram_link"   name="employee_instagram_link">
                        </div>
                        <div class="form-group">
                            <label for="employee_google_link"> GoogleLink</label>
                            <input type="text" class="form-control" id="employee_google_link"   name="employee_google_link">
                        </div>
                        <div class="form-group">

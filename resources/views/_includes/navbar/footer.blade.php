...
<div class="footer">
    <div class="container">
        ...
        <div class="logo-footer">
            ...
            <div class="col-md-3 agileinfo_footer_grid f1">
                ...
                <div class="agileinfo_footer_grid1">
                    <a href="#"><img src="{{asset('footer/images/fo1.jpg')}}" alt=" " class="img-responsive"></a>
                </div>
                <div class="agileinfo_footer_grid1">
                    <a href="#"><img src="{{asset('footer/images/fo2.jpg')}}" alt=" " class="img-responsive"></a>
                </div>
                <div class="agileinfo_footer_grid1">
                    <a href="#"><img src="{{asset('footer/images/fo3.jpg')}}" alt=" " class="img-responsive"></a>
                </div>
                <div class="agileinfo_footer_grid1">
                    <a href="#"><img src="{{asset('footer/images/fo4.jpg')}}" alt=" " class="img-responsive"></a>
                </div>
                <div class="agileinfo_footer_grid1">
                    <a href="#"><img src="{{asset('footer/images/fo4.jpg')}}" alt=" " class="img-responsive"></a>
                </div>
                <div class="agileinfo_footer_grid1">
                    <a href="#"><img src="{{asset('footer/images/fo6.jpg')}}" alt=" " class="img-responsive"></a>
                </div>
        ...
        <div class="w3agile_footer_copy">
            <p>© 2017 Handout. All rights reserved | Design by <a href="http://w3layouts.com/">W3layouts</a></p>
        </div>
        <!-- //copyright -->
        <!-- newsletter -->
